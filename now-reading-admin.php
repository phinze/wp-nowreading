...
function nr_add_head() {
	echo '<link rel="stylesheet" href="' . get_settings('wpurl') . '/wp-content/plugins/now-reading/admin.css" type="text/css" />';
	echo '<script type="text/javascript" src="' . get_settings('wpurl') . '/wp-content/plugins/now-reading/js/manage.js"></script>';
}
