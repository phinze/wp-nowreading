...
function nr_add_head() {
	echo '<link rel="stylesheet" href="' . bloginfo('wpurl') . '/wp-content/plugins/now-reading/admin.css" type="text/css" />';
	echo '<script type="text/javascript" src="' . bloginfo('wpurl') . '/wp-content/plugins/now-reading/js/manage.js"></script>';
}
